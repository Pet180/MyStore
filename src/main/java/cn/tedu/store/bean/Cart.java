...
public class Cart implements Serializable {
	...
	public Cart(Integer id, Integer uid, String goodsId, Integer count, String createdUser, Date createTime,
	...
	public String toString() {
		return "Cart [id=" + id + ", uid=" + uid + ", goodsId=" + goodsId + ", count=" + count + ", createdUser="
				+ createdUser + ", createTime=" + createdTime + ", modifiedUser=" + modifiedUser + ", modifiedTime="
				+ modifiedTime + "]";
	}
